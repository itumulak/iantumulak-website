    ...
    return (
        <Section id="about">
            ...
            <div className="flex flex-col gap-y-6">
                <Container>
                    <Reveal>
                        <p>First off, welcome to my personal website! My name is <strong className="font-bold text-brand">Ian</strong> if you haven't catch it yet. I am a full stack developer from Davao City, Philippines.</p>
                    </Reveal>
                    <Reveal>
